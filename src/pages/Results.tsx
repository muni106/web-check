  ...
  const resultCardData = [
    {
      ...
      id: 'server-info',
      title: i18next.t('server-info.title'),
      ...
      id: 'http-security',
      title: i18next.t('http-sec.title'),
      ...
      id: 'social-tags',
      title: i18next.t('social-tags.title'),
      ...
      id: 'trace-route',
      title: i18next.t('trace-route.title'),
      ...
      id: 'security-txt',
      title: i18next.t('security-txt.title'),
      ...
      id: 'dns-server',
      title: i18next.t('dns-server.title'), 
      ...
      id: 'mail-config',
      title: i18next.t("mail-config.title"), 
      ...
      id: 'archives',
      title: i18next.t('archives.title'),
      ...
      id: 'screenshot',
      title: i18next.t('screenshot.title'),
      ...
      title: i18next.t('tls-chipher-suites.title'),
      result: tlsResults,
      ...
      title: i18next.t('tls-client-support.title'),
      result: tlsResults,
      ...
      id: 'redirects',
      title: i18next.t('redirects.title'),
      ...
      id: 'linked-pages',
      title: i18next.t('linked-pages.title'),
      ...
      id: 'robots-txt',
      title: i18next.t('robots-txt.title'),
      ...
      id: 'block-lists',
      title: i18next.t('block-lists.title'),
      ...
      id: 'features',
      title: i18next.t('features.title'),
